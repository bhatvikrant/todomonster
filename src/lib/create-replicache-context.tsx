...
import { listen } from "src/app/replicacheActions";
...
const ReplicacheContextProvider = ({
  children,
}: {
...
const useReplicacheContext = () => {
  ...
  if (!context) {
    throw new Error(
      "useReplicacheContext must be used within a ReplicacheContextProvider",
    );
  }
  return context;
};

export { ReplicacheContextProvider, useReplicacheContext };
